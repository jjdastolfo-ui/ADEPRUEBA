...
function crear({ CAMPOS, getDB, plantelMod, animalesMod, destinosMod, finanzasMod }) {
  ...
  function resumen(empresaKey) {
    ...
    return { empresa: e.key, nombre: e.nombre, campos, finanzas: { configurado: !!e.finanzas.url, url: e.finanzas.url || null, campo: e.finanzas.campo },
  ...
  const lista = () => Object.values(empresas).map(e => ({ key: e.key, nombre: e.nombre, campos: e.campos, finanzas: !!e.finanzas.url }));
